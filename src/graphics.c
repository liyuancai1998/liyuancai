...
const u16 gIntroCopyright_Pal[] = INCBIN_U16("graphics/title_screen/bg/copyright.gbapal");
const u32 gIntroCopyright_Gfx[] = INCBIN_U32("graphics/title_screen/bg/copyright.8bpp.lz");
const u32 gIntroCopyright_Tilemap[] = INCBIN_U32("graphics/title_screen/bg/full.bin.lz");
