...
static const u32 g80x64QeTiles[] = INCBIN_U32("graphics/test/cycling_triathlete_f.4bpp.lz");
static const u32 g80x64QePal[] = INCBIN_U32("graphics/test/cycling_triathlete_f.gbapal.lz");
...
{
    [TRAINER_PIC_CYCLING_TRIATHLETE_F] = g80x64QeTiles,
...
{
    [TRAINER_PIC_CYCLING_TRIATHLETE_F] = g80x64QePal,
