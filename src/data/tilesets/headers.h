...
const struct Tileset gTileset_BubbleTilieset1 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_BubbleTilieset1,
    .palettes = gTilesetPalettes_BubbleTilieset1,
    .metatiles = gMetatiles_BubbleTilieset1,
    .metatileAttributes = gMetatileAttributes_BubbleTilieset1,
    .callback = NULL,
};

const struct Tileset gTileset_MAP01 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_MAP01,
    .palettes = gTilesetPalettes_MAP01,
    .metatiles = gMetatiles_MAP01,
    .metatileAttributes = gMetatileAttributes_MAP01,
    .callback = NULL,
};

const struct Tileset gTileset_map01t1 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_map01t1,
    .palettes = gTilesetPalettes_map01t1,
    .metatiles = gMetatiles_map01t1,
...
const struct Tileset gTileset_CAVET1 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CAVET1,
    .palettes = gTilesetPalettes_CAVET1,
    .metatiles = gMetatiles_CAVET1,
...
const struct Tileset gTileset_map04 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_map04,
    .palettes = gTilesetPalettes_map04,
    .metatiles = gMetatiles_map04,
    .metatileAttributes = gMetatileAttributes_map04,
    .callback = NULL,
};

const struct Tileset gTileset_mapg =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_mapg,
    .palettes = gTilesetPalettes_mapg,
    .metatiles = gMetatiles_mapg,
