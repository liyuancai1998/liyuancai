...
static const struct MenuAction MultichoiceList_SlateportHealWarp[] =
{
    {gText_HealParty},
    // {gText_ChunYu},
    {gText_Chenxi},
...
static const struct MenuAction MultichoiceList_LittlerootHealWarp[] =
{
    {gText_HealParty},
    {gText_ChunYu},
    // {gText_Chenxi},
...
static const struct MenuAction MultichoiceList_LavaridgeHealWarp[] =
{
    {gText_HealParty},
    {gText_ChunYu},
    {gText_Chenxi},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_LILYCOVE_HEAL_WARP]         = MULTICHOICE(MultichoiceList_LilycoveHealWarp),
    [MULTI_SLATEPORT_HEAL_WARP]        = MULTICHOICE(MultichoiceList_SlateportHealWarp),
    [MULTI_LITTLEROOT_HEAL_WARP]       = MULTICHOICE(MultichoiceList_LittlerootHealWarp),
    [MULTI_LAVARIDGE_HEAL_WARP]        = MULTICHOICE(MultichoiceList_LavaridgeHealWarp),
};
