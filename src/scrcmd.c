...
static const u8* sCGMessage[] = 
{
    ...
    [11] = COMPOUND_STRING("凯伊:你这个混蛋！\n你竟然敢对洛汐做这种事！\l你把洛汐当成什么了！\l我一定要让你付出代价！"),
    ...
    [35] = COMPOUND_STRING("洛汐:谢谢你还记得\n启明星公主的约定，\l当初要不是晓暄的阻挠，\l或许我们会很要好，\l甚至我们会……\l总之会有无限的可能吧。\l十年了，被困在这个地方，\l你一定很累了吧，\l我们的约定，还有我承诺的那部分，\l我也要将你从黑暗中拯救出来，\l让我们完成十年前未完成的祭祀，\l然后走向往生……\l希望在来生，\l我们可以拥有一个完美的结局……"),
    [36] = COMPOUND_STRING("()"),
